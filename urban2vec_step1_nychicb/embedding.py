...
image_path = 'data/image_cb.pickle'
old_ckpt_path = '/home/ubuntu/projects/urban2vec/urban2vec-pic3/checkpoint/cb/lr0.000500_mr5.000000/sv_embedding_20_last.tar'
...
if __name__ == '__main__':
    ...
    with open("embeddingny_cb.pickle","wb") as file:
        pickle.dump(embedding,file)
    with open("fipsny_cb.pickle","wb") as file:
